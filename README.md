...
Single-player downhill shopping-cart experiment. **Three hills, nine challenge combinations, and an earned cart-upgrade career.**
...
Steer with A/D or left/right; W/S or up/down lean; hold/release Space to jump (longer hold gives more height); release in the dip's striped exit for a speed boost; Shift brakes; Esc pauses; R immediately restarts. Stay left of the ramp for the safe route, or retain speed and take the right dumpster jump. Mute and reduced effects are available before play. Choose Downhill dash (beat the hill target), Sidewalk slalom (all six gates), or Air mail (gap plus clean landing without recovery). Finish Sunset Hill to unlock Market Mile, then finish Market Mile to unlock Quarry Drop. Earn bolts from finishes and spend them on bearings, steering, or suspension in the garage. Completion stars and separate time/score bests for each hill and challenge save locally. The start screen can reset local records.

- Read [docs/CAREER.md](docs/CAREER.md) for courses, obstacles, rewards, upgrades, and saved progress.
...
The user explicitly requested more levels, obstacles, speed, and unlockable upgrades on 2026-09-13. The career expansion follows that scope; original human mechanic gates remain pending. Automated replays cannot establish those subjective outcomes.
