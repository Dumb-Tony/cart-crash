...
## 2026-09-13: m2-1 career expansion

User explicitly requested more levels, obstacles, speed, and unlockable upgrades while keeping the current art style. Added Market Mile (2.4 km), Quarry Drop (3 km), barricades/cone clusters/oil/boost strips, higher starting speed and acceleration, and three purchasable upgrades earned from finish rewards. Course completion unlocks the next hill independently of challenge stars. Existing m1-6 settings, records, and stars migrate to a stable career save key.

Automated fixed-step regressions pass. Stock course replay times: Sunset 35.458 s, Market 42.883 s, Quarry 48.825 s, with zero recoveries and a gap plus clean landing on each. Fully upgraded: 34.100 / 40.800 / 46.558 s. All match across synthetic 30/60/120 FPS. Every other upgrade combination also finishes every hill without recovery. Stock Market/Quarry peak speeds 70/76 m/s; fully upgraded 77.05/81.10 m/s. Original safe/ramp replay times are now 35.300/35.050 s. All 63 ramp timing/lane tests still pass. Slalom reaches all six gates on both new hills; the simple direct-to-next-gate replay incurs one barricade recovery per new course, so avoiding those obstacles remains a player routing task. Swept barricade impact, jump clearance, recovery grace, cone/oil speed changes, single boost awards, upgrade affordability/duplicate rejection, payout once per finish, unlock order, malformed/blocked storage, and save/reload were checked. Developer replays cannot award career progress. Simulated ten-minute soak completed 17 finishes; no new real ten-minute soak is claimed.

Real in-app browser functional checks at 1280x720:
- Normal no-steering Sunset finish: 35.40 s, 150 bolts, Market unlocked.
- Normal no-steering Market finish: 48.75 s, one recovery, 101 score, 120 bolts, Quarry unlocked. Missing the dash target still correctly permits career progression.
- Garage purchase: 270 to 90 bolts after buying bearings; duplicate and unaffordable purchases disabled. Reload retained the purchase and both unlocks.
- Automated bearings-only Quarry full route: 47.01 s, 444 points, gap and clean landing, zero recoveries. During the route, 59.2 rendered FPS and 5.70 ms maximum measured render/simulation work; these are indicative browser observations, not universal performance guarantees.
- Automated bearings-only Market Air mail: 41.16 s, 317 points, gap and clean landing, zero recoveries.
- Practice runs left career currency at 90, with no new saved challenge records. Browser warning/error logs were empty. Course menu, garage, new curves, road hazards, and labels were visually inspected.

These are automated-input and functional browser checks, not fresh-player manual feel testing. Human mechanic gates remain unclaimed. The user authorized the content expansion independently of those gates.
